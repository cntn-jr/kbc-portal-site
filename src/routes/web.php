...
//管理者のルーティング
Route::prefix('kbc_administrator/semester')->group(function(){
...
Route::prefix('kbc_administrator/teachers')->group(function(){
...
//教師のルーティング
Route::prefix('kbc_teacher/class')->group(function(){
    //クラスの選択
    Route::get('/', [ClassesController::class, 'select_class'])->name('class.select');
...
Route::prefix('kbc_teacher/class/{class_id}/curriculum')->group(function(){
    //カリキュラム（１コマ）の追加
...
Route::prefix('kbc_teacher/class/{class_id}/lesson')->group(function(){
    //授業
...
Route::prefix('kbc_teacher/class/{class_id}/announcement')->group(function(){
    //お知らせ
...
Route::prefix('kbc_teacher/class/{class_id}/schedule')->group(function(){
    //スケジュール
...
Route::prefix('kbc_teacher/class/{class_id}/student')->group(function(){
    //生徒アカウントの作成
...
Route::prefix('kbc_teacher')->group(function(){
    //年度の切り替え
...
//生徒のルーティング
Route::prefix('kbc_student/class/{class_id}')->group(function(){
...
Route::prefix('kbc_student')->group(function(){
